package com.practice.demo.filtering;
...
import com.practice.demo.models.SomeBean;

@RestController
public class FilteringController {

	@GetMapping("/filtering")
	private MappingJacksonValue retrieveSomeBean() {
	...
	private MappingJacksonValue retrieveListOfSomeBean() {
